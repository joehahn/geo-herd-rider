...
- **Catalyst** — the storyline's **spine**: the single driving through-line that *resolves once* (that resolution is the **exit**). For "Hormuz blockade" the spine is *Iran's push to close the Strait of Hormuz*, and it resolves at the **ceasefire**. Several tickers can **share** one catalyst (a *same-catalyst* basket).
