...
flowchart LR
    ...
    CAT["🎯 Catalyst<br/>the discrete driver:<br/>war · rare-earth curb ·<br/>bill · supply shock"] === EV["<b>EVENT</b><br/><i>the durable unit</i>"] === AGT["🟢 Event-agent<br/>exactly ONE per event;<br/>tracks it weekly;<br/>live/exit + conviction 1–10"]
