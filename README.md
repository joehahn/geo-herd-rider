...
- An **event** is flagged by the **scout**, and it is the real-world thing that is unfolding, and it is the storyline that this solution is tracking (e.g. "Hormuz blockade").
