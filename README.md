...
- **Milestones** are the **vertebrae** on that spine: the developments along the way (*protests in Iran → a US carrier group to the Med → strikes on Iran → the Hormuz closure itself*) that keep the catalyst *live*. The event-agent watches for them each week: a fresh one lifts the event's `conviction`, a quiet week decays it. They're beats of the one event, not separate catalysts.
