...
- **Milestones** are the vertebrae on the spine, they are the developments along the way (*protests in Iran → a US carrier group to the Med → strikes on Iran → the Hormuz closure itself*) that keep the catalyst *live* and feed the event's **conviction**. They're beats of the one event, not separate catalysts.
- **Conviction** is the event-agent's weekly rating, 1–10, of how live and still-under-owned the catalyst is. A fresh milestone lifts it while silence or a priced-in market causes it to decay over time.
