...
This Claude Code project is the third in a family. [`portfolio-wave-rider`](https://github.com/joehahn/portfolio-wave-rider) paired an LLM watchlist curator with a plain mean-variance optimizer; [`geo-wave-rider`](https://github.com/joehahn/geo-wave-rider) then tested a faster, event-driven idea — *can you ride a politician's market-moving post?* — and returned a clean **no** for the naive version. The full prior result is preserved in [`prior-work/geo-wave-rider-phase1.md`](prior-work/geo-wave-rider-phase1.md). geo-herd-rider keeps the surviving lesson and builds the disciplined version.
