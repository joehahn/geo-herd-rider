...
The sections below explain each box in greater detail — the [Firehose](#the-news-firehose-why-reading-beats-reasoning), the [Curator](#inside-the-curator-scout--per-event-agents) (scout, matcher, per-event agents), and the [watchlist and optimizer](#the-signal-and-its-jobs).
