...
min_trade_size: 0.4               # Drop holdings smaller than this & reallocate
max_agents: 10                     # Keep only the top-N agents in the weekly watchlist, incl. the always-on SPY agent; 0 = uncapped
...
lookback_period_days: 45           # Optimizer trailing lookback (calendar days); short = responsive to recent moves
