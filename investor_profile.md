...
max_agents: 6                     # Keep only the top-N agents in the weekly watchlist, incl. the always-on SPY agent; 0 = uncapped
spy_agent_conviction: 6           # Conviction of the always-on SPY agent in the max_agents ranking; a live event must out-rank it to take a slot
defensive_agent_conviction: 6     # a 2nd always-on defensive-default agent (parks faded-event capital in the defensive asset); 0 = off
