...
<body><div class="wrap">
 ...
 <h2>Gain vs conviction over time — every gem's agents <span class="sub" style="font-size:13px;font-weight:400">— each line is one agent's path through (catalyst-conviction&nbsp;x, cumulative&nbsp;$&nbsp;gain&nbsp;y), week by week, colored by gem. Up-and-right = conviction and gain rising together (a good, self-aware thesis); high on x but sinking on y = high conviction that isn't paying off.</span></h2>
