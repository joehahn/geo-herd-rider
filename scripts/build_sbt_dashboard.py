...
def main(argv=None) -> int:
    ...
    panels = "".join([
        ...
        ('<section class="panel"><h2>10. The best region of the grid</h2><p class="lead">'
         ...
         "mean-over-noise form measures +0.97 against Sharpe. "
         "<b>PCR vs SPY</b> is the one that votes: the median of the PAIRED per-period differences, "
         "book minus SPY. That pairing is what makes it a metric at all \u2014 SPY\u2019s median is a "
         "single number per curation, so subtracting it from PCR would be a constant offset and "
         "reorder nothing (rho 1.0000). Subtracting period by period reorders (rho 0.65\u20130.76), "
         "and adding it lifts out-of-sample selection at every cut size tested, worst pair 31 "
         "\u2192 58. "
