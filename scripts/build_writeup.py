...
<p>This is a cost-optimization exercise. The goal is not to crown the best model, it is to find the
most capability per dollar. So I used a top-of-the-line frontier model to judge the other models'
decisions. <b>Claude Fable 5 never touched the production path. It re-read the decisions the eight
